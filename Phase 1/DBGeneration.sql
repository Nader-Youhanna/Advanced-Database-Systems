...
ALTER TABLE
    Employee
ADD
    CONSTRAINT FK_Employee_Super_Ssn FOREIGN KEY (Super_Ssn) REFERENCES Employee(Ssn)
    ON DELETE NO ACTION
GO
...
ALTER TABLE
    Department_Location
ADD
    CONSTRAINT FK_Department_Location_Dnumber FOREIGN KEY (Dnumber) REFERENCES Department(Dnumber)
    ON DELETE CASCADE
GO
--------------------------------------------------------------------------------------------------